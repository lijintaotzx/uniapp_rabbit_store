...
import { getCategoryPageApi } from '@/services/category'
...
const categoryData = ref<categoryPageItem[]>([])
...
onLoad(async () => {
  await Promise.all([getHomeBanner(), getPageData()])
  ...
  <view class="viewport" v-else>
    ...
    <view class="categories">
      ...
      <scroll-view class="secondary" scroll-y>
        <!-- 焦点图 -->
        <XtxSwiper class="banner" :banner-list="bannerList" />
        <!-- 内容区域 -->
        <view class="panel" v-for="item in categoryDetail" :key="item.id">
          <view class="title">
            <text class="name">{{ item.name }}</text>
